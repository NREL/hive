...
with open(scenario_file, 'r') as f:
    config = HiveConfig.build(yaml.safe_load(f))

if not config.sim or not config.sim.sim_name:
    raise ImportError("please specify a sim.sim_name for this run")

sim_output_dir = os.path.join(config.io.output_directory, config.run_name())
