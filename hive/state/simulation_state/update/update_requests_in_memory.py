...
class UpdateRequestsMemory(NamedTuple, SimulationUpdateFunction):
    """
    ...
    def build(cls, request_file: str, rate_structure_file: Optional[str] = None):
        ...
        drs = DictReaderStepper.from_iterator(reader, "departure_time", parser=time_parser)

        return UpdateRequestsMemory(drs, rate_structure)

    def update(self,
               sim_state: SimulationState,
               env: Environment) -> Tuple[SimulationUpdateResult, Optional[UpdateRequestsMemory]]:
        """
