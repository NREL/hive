...
def add_membership(
        membership_collection: MembershipMap,
        member_id: MemberId,
        entity_id: EntityId,
) -> MembershipMap:
    return DictOps.add_to_collection_dict(membership_collection, member_id, entity_id)
