...
def initialize_simulation(
    ...
    fleet_ids = read_fleet_ids_from_file(
        config.input_config.fleets_file) if config.input_config.fleets_file else []
...
def _build_vehicles(
    ...
    """
    def _add_row_unsafe(payload: Tuple[SimulationState, Environment],
