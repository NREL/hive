...
class TerminalStateEffectOps(SwitchCase):
    ...
    @classmethod
    def _case_serving_trip(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
    ...
    @classmethod
    def _case_dispatch_trip(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
        sim_state = arguments.simulation_state
        vehicle_id = arguments.vehicle_id
        vehicle = sim_state.vehicles[vehicle_id]
    ...
    @classmethod
    def _case_dispatch_station(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
        sim_state = arguments.simulation_state
        vehicle_id = arguments.vehicle_id
        vehicle = sim_state.vehicles[vehicle_id]
        at_location = sim_state.at_geoid(vehicle.geoid)
    ...
    @classmethod
    def _case_dispatch_base(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
        sim_state = arguments.simulation_state
        vehicle_id = arguments.vehicle_id
        vehicle = sim_state.vehicles[vehicle_id]
        at_location = sim_state.at_geoid(vehicle.geoid)
    ...
    @classmethod
    def _case_repositioning(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
        sim_state = arguments.simulation_state
        vehicle_id = arguments.vehicle_id
        vehicle = sim_state.vehicles[vehicle_id]
    ...
    @classmethod
    def _case_charging_station(cls, arguments: TerminalStateEffectArgs) -> 'SimulationState':
        sim_state = arguments.simulation_state
        vehicle_id = arguments.vehicle_id
        vehicle = sim_state.vehicles[vehicle_id]
