...
class TestVehicleState(TestCase):
    ...
    def test_charging_station_update(self):
        ...
        self.assertEqual(entered_state.instance_id, updated_vehicle.vehicle_state.instance_id,
    ...
    def test_charging_station_subsequent_charge_instructions(self):
        ...
        self.assertNotEqual(entered_state.instance_id, next_entered_state.instance_id,
 ...
 \
    ...
    def test_servicing_trip_update(self):
        ...
        self.assertEqual(updated_vehicle.vehicle_state.request, request, "should have passengers")
        self.assertEqual(entered_state.instance_id, updated_vehicle.vehicle_state.instance_id,
                         "should be the same instance")
