...
class TestH3Ops(TestCase):
    def test_point_along_link(self):
        ...
        start = h3.latlng_to_cell(37, 122, 15)
        end = h3.latlng_to_cell(37.008994, 122, 15)
    ...
    def test_nearest_entity_point_to_point(self):
        somewhere = h3.latlng_to_cell(39.748971, -104.992323, 15)
        close_to_somewhere = h3.latlng_to_cell(39.753600, -104.993369, 15)
        far_from_somewhere = h3.latlng_to_cell(39.728882, -105.002792, 15)
    ...
    def test_nearest_entity(self):
        ...
        h3_resolution = 15
        h3_search_res = 7
        somewhere = h3.latlng_to_cell(39.7539, -104.974, h3_resolution)
        near_to_somewhere = h3.latlng_to_cell(39.754, -104.975, h3_resolution)
        far_from_somewhere = h3.latlng_to_cell(39.755, -104.976, h3_resolution)
    ...
    def test_great_circle_distance(self):
        london = h3.latlng_to_cell(51.5007, 0.1246, 10)
        new_york = h3.latlng_to_cell(40.6892, 74.0445, 10)
