...
class TestTabularPowercurve(TestCase):
    ...
    def test_leaf_energy_gain_0_soc(self):
        ...
        result = leaf_model.refuel(energy_source, Charger.DCFC, 2 * unit.hour)
    ...
    def test_leaf_energy_gain_full_soc(self):
        ...
        result = leaf_model.refuel(energy_source, Charger.DCFC, 1 * unit.hour)
    ...
    def test_leaf_energy_gain_low_power(self):
        ...
        result = leaf_model.refuel(energy_source, Charger.LEVEL_2, 1 * unit.hour)
