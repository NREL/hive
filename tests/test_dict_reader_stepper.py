...
class TestDictReaderStepper(TestCase):
    ...
    def test_reading_up_to_a_time_bounds_should_leave_remaining_file_available(self):
        ...
        stop_time = time_parser('1970-01-01T00:12:00')
    ...
    def test_reading_two_consecutive_times(self):
        test_filename = resource_filename("hive.resources.scenarios.denver_downtown.requests",
                                          "denver_demo_requests.csv")
        _, stepper = DictReaderStepper.from_file(test_filename, "departure_time", parser=time_parser)
        stop1 = time_parser('1970-01-01T00:12:00')
        stop2 = time_parser('1970-01-01T00:14:00')
    ...
    def test_no_agents_after_end_of_file(self):
        test_filename = resource_filename("hive.resources.scenarios.denver_downtown.requests",
                                          "denver_demo_requests.csv")
        _, stepper = DictReaderStepper.from_file(test_filename, "departure_time", parser=time_parser)
        _ = tuple(stepper.read_until_stop_condition(self._generate_stop_condition(time_parser(9999998))))
        result = tuple(stepper.read_until_stop_condition(self._generate_stop_condition(time_parser(9999999))))
    ...
    def test_no_second_file_reading_on_repeated_value(self):
        test_filename = resource_filename("hive.resources.scenarios.denver_downtown.requests",
                                          "denver_demo_requests.csv")
        _, stepper = DictReaderStepper.from_file(test_filename, "departure_time", parser=time_parser)
        stop = time_parser('1970-01-01T00:12:00')
    ...
    def test_correct_management_of_stored_value_after_repeated_value(self):
        ...
        stop2 = time_parser('1970-01-01T00:13:00')
